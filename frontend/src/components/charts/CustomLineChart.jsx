...
const CustomLineChart = ({ data }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-900 to-indigo-700 p-4 rounded-2xl shadow-xl">
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={data}>
          ...
          <XAxis
            dataKey="month"
            tick={{ fontSize: 12, fill: "#e0e7ff" }}
            stroke="none"
          />
          <YAxis tick={{ fontSize: 12, fill: "#e0e7ff" }} stroke="none" />
          ...
          <Area
            ...
            strokeWidth={4}
            dot={{ r: 5, fill: "#ffffff", stroke: "#70a1ff" }}
          />
        </AreaChart>
      </ResponsiveContainer>
    </div>
