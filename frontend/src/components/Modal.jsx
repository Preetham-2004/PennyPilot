...
const Modal = ({children, isOpen, onClose, title}) => {   
    ...
    return (
        <div className=" fixed top-0 right-0 left-0 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50">
            <div className="relative p-4 w-full rounded-lg shadow-sm dark:bg-gray-800 ">
