...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0A1628] via-[#0A1628] to-[#312E81] relative overflow-hidden">
      ...
      <div className="min-h-screen min-w-[500px] flex items-center justify-center p-4 relative z-10">
        <motion.div
          initial="hidden"
          animate="visible"
              ...
              <motion.div variants={itemVariants}>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:border-fuchsia-400 focus:ring-2 focus:ring-fuchsia-400/20 transition-all duration-200 text-white placeholder:text-indigo-300/50"
                  />
                </div>
              </motion.div>
