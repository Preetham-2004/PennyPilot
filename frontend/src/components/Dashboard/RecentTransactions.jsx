...
const RecentTransactions = ({ transactions = [], onSeeMore }) => {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="w-full md:w-[800px] lg:w-[640px] min-h-[720px]"
    >
      <div className="relative">
        ...
        <div className="relative bg-[#0A1628]/95 backdrop-blur-xl rounded-3xl border border-blue-500/10 shadow-2xl shadow-black/20 min-h-[700px]">
          {/* Header Section */}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-300/50">Latest transaction records</p>
                </div>
              </div>
            ...
            {transactions && transactions.length > 0 ? (
              transactions.slice(0, 5).map((transaction) => (
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/[0.08] transition-all duration-300">
                    <div className="flex items-center gap-3">
                      <motion.div
                    ...
                    <motion.div
                      ...
                      className={`px-5 py-2 rounded-xl font-medium bg-white/[0.02] border border-white/[0.05] ${
                        transaction.type === 'income'
                          ? 'text-blue-400'
                          : 'text-blue-200'
                      }`}
                    >
                      <span className="text-sm">{transaction.type === 'income' ? '+' : '-'} ${transaction.amount}</span>
                    </motion.div>
                  </div>
                </motion.div>
              ))
