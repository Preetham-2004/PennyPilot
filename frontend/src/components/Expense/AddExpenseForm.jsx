      ...
      <div className="w-full max-w-md bg-white rounded-2xl p-8 shadow-2xl relative">
        ...
        <div className="mb-8 relative">
          ...
          >
            ...
            <span className="text-gray-700 font-medium">Choose Category Icon</span>
          </button>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              type="text"
              className="w-full px-4 py-3.5 bg-gray-100 rounded-xl border-2 border-transparent placeholder-gray-400 text-gray-900 focus:border-red-500 focus:ring-0 transition-colors font-medium"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                type="number"
                className="w-full pl-8 pr-4 py-3.5 bg-gray-100 rounded-xl border-2 border-transparent placeholder-gray-400 text-gray-900 focus:border-red-500 focus:ring-0 transition-colors font-medium"
              />
            </div>
          </div>
        ...
        <div className="mt-8">
          <button
            type="button"
            className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600  text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
